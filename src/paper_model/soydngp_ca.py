"""Paper model, verbatim port (PAPER_MODEL_V1).

Source:
    IndigoFloyd/SoybeanWebsite, AlexNet_206.py
    commit f724d9b1974bb78b7832b191af99f589a2c5e549 (fetched 2026-09-11)

Porting policy: verbatim copy, no refactoring. Known quirks (modules()
override, missing forward(), biased final Linear) are documented in
